...
Public Class Chrome_Canary
    ...
    Private Sub Label6_Click(sender As Object, e As EventArgs) Handles Label6.Click
        ...
        Panel7.Hide()
        Panel1.Hide()
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_7827459f1076447db1040530d527497c.zip"), TextBox1.Text)

...
Public Class Edge
    ...
    Private Sub Label6_Click(sender As Object, e As EventArgs) Handles Label6.Click
        ...
        Panel1.Hide()
        Panel7.Hide()
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_47d48edb722748eb8a276910458b2320.zip"), TextBox1.Text)
    End Sub

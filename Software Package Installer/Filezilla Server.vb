...
Public Class Filezilla_Server
    ...
    Private Sub Label6_Click(sender As Object, e As EventArgs) Handles Label6.Click
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_988f60413e0942e7939bf149fb0326b3.zip"), TextBox1.Text)
        ProgressBar1.Show()
        Panel7.Hide()
        Panel1.Hide()
    End Sub

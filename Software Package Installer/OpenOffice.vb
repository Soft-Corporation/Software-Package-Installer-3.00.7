...
Public Class OpenOffice
    ...
    Private Sub Label6_Click(sender As Object, e As EventArgs) Handles Label6.Click
        ...
        Panel7.Hide()
        Panel1.Hide()
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_483553da9df44a21906c71a35cd463a5.zip"), TextBox1.Text)
    End Sub
